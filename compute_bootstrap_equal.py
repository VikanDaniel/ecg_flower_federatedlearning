...
# This file was created by Gemini AI with user guidance to analyze the results of the equal experiment.
...
if __name__ == "__main__":
    print("\nLoading data...")
    l0, p_iso0  = load('equal_iso_client0')
    _,  p_cent0 = load('equal_cent_client0')
    _,  p_fl0   = load('equal_fl_client0')
    
    l1, p_iso1  = load('equal_iso_client1')
    _,  p_cent1 = load('equal_cent_client1')
    _,  p_fl1   = load('equal_fl_client1')

    print("\nComputing bootstrap CIs and p-values (10,000 iterations) for EQUAL datasets")
    ...
    print("Bootstrap iterations: 10,000 | Seed: 42")
