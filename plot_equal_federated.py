...
def main():
    print("==================================================")
    print(" Generating Equal Federated Comparison Graphs...")
    print("==================================================")
    
    # GRAPH 1: PTB-DB
    exp_small = [
        {"name": "EQUAL Federated Learning (Tested on PTB-DB)", "prefix": "equal_fl_client1", "color": "black"},
        {"name": "EQUAL Isolated Training (Tested on PTB-DB)", "prefix": "equal_iso_client1", "color": "#d62728"}
    ]
    draw_graph(exp_small, "PTB-DB (EQUAL Dataset Impact)", "Graph_Equal_Federated_PTBDB.png")
    
    # GRAPH 2: PTB-XL
    exp_large = [
        {"name": "EQUAL Federated Learning (Tested on PTB-XL)", "prefix": "equal_fl_client0", "color": "black"},
        {"name": "EQUAL Isolated Training (Tested on PTB-XL)", "prefix": "equal_iso_client0", "color": "#d62728"}
    ]
    draw_graph(exp_large, "PTB-XL (EQUAL Dataset Impact)", "Graph_Equal_Federated_PTBXL.png")
