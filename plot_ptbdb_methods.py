...
# This file was created by Gemini AI with user guidance to create a plot for the primary experiment (PTB-DB).
...
def main():
    print("Generating graph for PTB-DB (Client 1)...")
    
    experiments = [
        {"name": "Centralized Training", "prefix": "cent_client1", "color": "#1f77b4", "linestyle": "--"},
        {"name": "Federated Learning", "prefix": "fl_client1", "color": "#d62728", "linestyle": "-"},
        {"name": "Isolated Training", "prefix": "iso_client1", "color": "#000000", "linestyle": ":"}
    ]
    ...
    ax_roc.set_title("ROC Curve: PTB-DB Hospital", fontsize=16, fontweight='bold')
    ...
    # Styling PR
    ax_pr.set_title("Precision-Recall Curve: PTB-DB Hospital", fontsize=16, fontweight='bold')
    ax_pr.set_xlabel("Recall", fontsize=12)
    ax_pr.set_ylabel("Precision", fontsize=12)
    ax_pr.legend(fontsize=10, loc='lower left', frameon=True)
    ax_pr.grid(True, alpha=0.3)
    
    plt.suptitle("Performance on PTB-DB Dataset Across Training Methods", fontsize=18, fontweight='bold', y=1.05)
    plt.tight_layout()
    
    filename = "Graph_PTBDB_Methods.png"
