...
def main():
    print("==================================================")
    print(" Generating Equal Isolated Gap Graph...")
    print("==================================================")
    
    exp_inequality = [
        {"name": "EQUAL PTB-XL Isolated Model (Tested on PTB-XL)", "prefix": "equal_iso_client0", "color": "#1f77b4"},
        {"name": "EQUAL PTB-DB Isolated Model (Tested on PTB-DB)", "prefix": "equal_iso_client1", "color": "#d62728"}
    ]
    draw_graph(exp_inequality, "The EQUAL Isolated Inequality Gap", "Graph_Equal_Isolated_Gap.png")
