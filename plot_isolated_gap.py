...
def main():
    print("==================================================")
    print(" Generating Isolated Inequality Graph...")
    print("==================================================")
    
    exp_inequality = [
        {"name": "PTB-XL Isolated Model (Tested locally on PTB-XL)", "prefix": "iso_client0", "color": "#1f77b4"},
        {"name": "PTB-DB Isolated Model (Tested locally on PTB-DB)", "prefix": "iso_client1", "color": "#d62728"}
    ]
    draw_graph(exp_inequality, "The Isolated Inequality Gap", "Graph_Isolated_Gap.png")
