...
def main():
    print("==================================================")
    print(" Generating Federated Comparison Graphs...")
    print("==================================================")
    
    # GRAPH 1: PTB-DB
    exp_small = [
        {"name": "Federated Learning (Tested on PTB-DB)", "prefix": "fl_client1", "color": "black"},
        {"name": "Isolated Training (Tested on PTB-DB)", "prefix": "iso_client1", "color": "#d62728"}
    ]
    draw_graph(exp_small, "PTB-DB (Small Hospital Impact)", "Graph_Federated_PTBDB.png")
    
    # GRAPH 2: PTB-XL
    exp_large = [
        {"name": "Federated Learning (Tested on PTB-XL)", "prefix": "fl_client0", "color": "black"},
        {"name": "Isolated Training (Tested on PTB-XL)", "prefix": "iso_client0", "color": "#d62728"}
    ]
    draw_graph(exp_large, "PTB-XL (Massive Hospital Impact)", "Graph_Federated_PTBXL.png")
